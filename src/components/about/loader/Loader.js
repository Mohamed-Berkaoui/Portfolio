...
function Loader() {
  ...
  const scale = useTransform(scrollY, [0,330,800,810], [0.03,1,1,0]);
  const x = useTransform(scrollY, [0,330], ['0','840vw']);
  const y = useTransform(scrollY, [0,330], ['0','14vh']);
  ...
  return (
   ...
   <div ref={carouselRef}  className='headerabout'>
 <div class="wrapper">
		<span></span>
		<span></span>
		<span></span>
  ...
  animate={{ pathLength: 1,  fill: "black" ,fillOpacity:1}}
  transition={{
